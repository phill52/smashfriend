...
function ProfileComponent({ user }) {
  ...
  return (
    <div className="flex w-full justify-end text-white">
      <div className="bg-blue-midnight border-purple-midnight mt-1.5 mr-2 rounded-lg border p-2.5 text-center font-bold text-white">
        Your Profile
        <div className="p-4">
          <img
          ...
          <div className="pt-1.5 text-sm">
            <p>{user.username}</p>
            <div className="text-smokey-white mb-0.5 text-xs">
            ...
            <div className="pt-1">
              ...
              <p>{user.rank}</p>
              <div className="text-smokey-white mb-1 text-xs">
